...
while the usual approaches in R, including  [`sandwich`](https://CRAN.R-project.org/package=sandwich) and [`estimatr`](http://declaredesign.org/R/estimatr/), and Python (e.g. [`statsmodels`](http://www.statsmodels.org/stable/index.html)) estimate the following hat matrix
