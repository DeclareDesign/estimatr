...
<td align="right">16555</td>
    ...
    #>  [1] ivpack_1.2              AER_1.2-5              
    #>  [3] survival_2.41-3         car_3.0-0              
    #>  [5] carData_3.0-1           clubSandwich_0.3.2     
    #>  [7] lmtest_0.9-36           zoo_1.8-1              
    #>  [9] sandwich_2.4-0          RcppArmadillo_0.8.500.0
    #> [11] RcppEigen_0.3.3.4.0     microbenchmark_1.4-4   
    #> [13] estimatr_0.7.0         
    #> 
    #> loaded via a namespace (and not attached):
    #>  [1] zip_1.0.0         Rcpp_0.12.17      highr_0.6        
    #>  [4] cellranger_1.1.0  compiler_3.5.0    pillar_1.2.3     
