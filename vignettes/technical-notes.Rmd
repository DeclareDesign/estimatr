...
This document provides the technical notes defining what each of the main functions in this package is estimating.
...
where $\widetilde{\x}_i$ is a vector of pre-treatment covariates for unit $i$ that have been centered to have mean zero and $d_i$ is an indicator for the treatment group. @lin2013 proposed this estimator in response to the critique by @freedman2008 that using regression to adjust for pre-treatment covariates could bias estimates of treatment effects.
