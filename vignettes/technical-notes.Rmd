...
If the user specifies weights, inference is done entirely by `lm_robust` for now. This may change in the future, anf got now we still rely on the degrees of freedom from the below table. Lastly, specifying weights with a matched-pairs estimator in `difference_in_means` is not supported at the moment.
