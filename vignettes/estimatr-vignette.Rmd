...
* $\pi_i(z)$ is the marginal probability of being in condition $z \in \{0, 1\}$ for unit i
* $\pi_{ij}(z_i, z_j)$ is the joint probability of unit $i$ being in condition $z_i$ and unit $j$ being in condition $z_j$

## Estimates
\[
\hat{\tau} = \frac{1}{N} \sum^N_{i=1} z_i \frac{y_i}{\pi_i(1)} - (1 - z_i) \frac{y_i}{\pi_i(0)} 
\]
]

## Variance

Currently we provide variance estimates that rely on two separate assumption.
