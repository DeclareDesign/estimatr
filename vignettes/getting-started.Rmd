...
The most up-to-date version of this vignette can be found on the [DeclareDesign website here](/R/estimatr/articles/getting-started.html).
...
The output of a `lm_lin()` call can be used with the same methods as `lm_robust()`.
