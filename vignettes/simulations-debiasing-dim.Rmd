...
blocked_assign <- declare_assignment(Z = block_ra(N, blocks = blocks, prob = 0.5), legacy = FALSE)
# Estimand is the ATE
...
clustered_assign <- declare_assignment(Z = cluster_ra(N, clusters = clusters, prob = 0.5), legacy = FALSE)
