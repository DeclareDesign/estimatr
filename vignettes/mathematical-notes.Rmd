...
`lm_lin()` is a pre-processor for `lm_robust()` implementing the covariate adjustment of @lin2013, which answers @freedman2008's demonstration that regression adjustment reduce precision. Rather than
