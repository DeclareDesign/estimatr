...
This document provides the mathematical notes for each of the estimators in `estimatr`. The most up-to-date version of this can be found on the [DeclareDesign website here](http://estimatr.declaredesign.org/articles/mathematical-notes.html).
