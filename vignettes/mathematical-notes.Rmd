...
This document provides the mathematical notes for each of the estimators in `estimatr`. The most up-to-date version of this can be found on the [DeclareDesign website here](http://declaredesign.org/R/estimatr/articles/mathematical-notes.html).
