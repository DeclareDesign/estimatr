...
This document exposes the properties of different variance estimators using [`DeclareDesign`](http://declaredesign.org) and [`estimatr`](/R/estimatr/). More details about the variance estimators with references can be found in the [mathematical notes](/R/estimatr/articles/mathematical-notes.html).
