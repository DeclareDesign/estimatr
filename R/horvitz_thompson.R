...
#'   \itemize{
#'     \item An `ra_declaration` from `randomizr`: \strong{strongly
...
#'       an `ra_declaration` to get the tighter design-aware variance.
...
#'   }
#' @param condition1 (optional) Label of the control condition (first sorted condition
#'   by default).
#' @param condition2 (optional) Label of the treatment condition (second sorted
#'   condition by default).
#' @param se_type (optional) `"youngs"` (default) or `"none"`.
#' @param ci (optional) Logical; whether to compute p-values and confidence intervals.
#' @param alpha (optional) Significance level, 0.05 by default.
#'
#' @return An object of class `"horvitz_thompson"` with fields
